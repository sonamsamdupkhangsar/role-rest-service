...
public interface OrganizationRole {
    ...
    Mono<String> updateRoleUser(Flux<Map> mapMono);
    Mono<Page<RoleUser>> getRoleUsers(UUID roleId, Pageable pageable);
    Mono<RoleUser> getRoleForUser(UUID clientId, UUID userId);
}
